...
- Published GitHub release page: `https://github.com/koyan9/spring-privacy-guard/releases/tag/v0.5.0`
...
- Latest published release notes: `docs/releases/RELEASE_NOTES_v0.5.0.md`
...
- Newly landed in the current development cycle:
  ...
  - explicit tenant-native dead-letter delete-by-id / replay-by-id capability flags and write-path telemetry
  - stable tenant dead-letter alert route, delivery, and monitoring policy resolution
...
- Need tenant-specific receiver route rehearsal commands for JDBC / Redis / postgres-redis: read `samples/privacy-demo/README.md`
- Need to understand the latest sample route and multi-instance regression coverage: inspect `samples/privacy-demo/src/test/java/com/example/privacydemo/`
...
- Published release dry run: `docs/RELEASE_DRY_RUN_v0.5.0.md`
- Published GitHub release copy: `docs/GITHUB_RELEASE_COPY_v0.5.0.md`
- Published release announcement: `docs/RELEASE_ANNOUNCEMENT_v0.5.0.md`
- Published release announcement (zh-CN): `docs/RELEASE_ANNOUNCEMENT_v0.5.0.zh-CN.md`
