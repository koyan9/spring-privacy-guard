...
@SpringBootTest(
        classes = {
                PrivacyGuardWebhookReceiverFilterIntegrationTest.TestApplication.class,
                PrivacyGuardWebhookReceiverFilterIntegrationTest.AlertReceiverController.class
        },
        properties = {
                "privacy.guard.audit.enabled=false",
                "privacy.guard.audit.dead-letter.observability.alert.receiver.filter.enabled=true",
                "privacy.guard.audit.dead-letter.observability.alert.receiver.filter.path-pattern=/receiver/alerts"
        }
)
@AutoConfigureMockMvc
class PrivacyGuardWebhookReceiverFilterIntegrationTest {
    ...
    void allowsValidSignedWebhookRequests() throws Exception {
        ...
        mockMvc.perform(post("/receiver/alerts")
