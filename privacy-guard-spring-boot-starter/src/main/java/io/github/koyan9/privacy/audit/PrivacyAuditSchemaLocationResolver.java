...
public class PrivacyAuditSchemaLocationResolver {

    public static final String GENERIC_SCHEMA = "classpath:META-INF/privacy-guard/privacy-audit-schema-generic.sql";
    public static final String H2_SCHEMA = "classpath:META-INF/privacy-guard/privacy-audit-schema-h2.sql";
    public static final String POSTGRESQL_SCHEMA = "classpath:META-INF/privacy-guard/privacy-audit-schema-postgresql.sql";
    public static final String MYSQL_SCHEMA = "classpath:META-INF/privacy-guard/privacy-audit-schema-mysql.sql";

    public String resolve(PrivacyGuardProperties.Jdbc jdbcProperties, DataSource dataSource) {
